...
public class UpdateItemProcParamHelper implements StoredProcedureHelper {

	private int updateCount;
	private int[] updateItemId;
	private double [] updateItemValue;
	...
	public double  getUpdateItemValue(int index) {
		return updateItemValue[index];
	}
